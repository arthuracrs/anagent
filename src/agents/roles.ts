import type { AgentDefinition, AgentResult } from './base.js'

function parseRoleOutput(raw: string): AgentResult {
...
export const developerAgent = role(
  'developer',
  'Implements features and fixes bugs. Writes clean, working code.',
  `You are a developer agent. Your job is to implement the task described by the user.
...
export const reviewerAgent = role(
  'reviewer',
  'Reviews code for bugs, security issues, and design problems.',
  `You are a reviewer agent. Your job is to review the code or changes described by the user.
